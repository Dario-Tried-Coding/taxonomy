...
type CoreRouteElements<Params extends z.ZodSchema, Search extends z.ZodSchema = typeof emptySchema> = {
...
> = CoreRouteElements<Params, Search> & {
  (body: z.input<Body>, p?: z.input<Params>, search?: z.input<Search>, options?: FetchOptions): Promise<z.output<Result>>
...
type GetRouteBuilder<Params extends z.ZodSchema, Search extends z.ZodSchema, Result extends z.ZodSchema> = CoreRouteElements<Params, Search> & {
  (p?: z.input<Params>, search?: z.input<Search>, options?: FetchOptions): Promise<z.output<Result>>
...
export type RouteBuilder<Params extends z.ZodSchema, Search extends z.ZodSchema> = CoreRouteElements<Params, Search> & {
  (p?: z.input<Params>, search?: z.input<Search>, targetHTML?: string): string
...
function createPathBuilder<T extends Record<string, string | string[]>>(route: string): (params: T) => string {
...
function createRouteBuilder<Params extends z.ZodSchema, Search extends z.ZodSchema>(route: string, info: RouteInfo<Params, Search>) {
  const fn = createPathBuilder<z.output<Params>>(route)

  return (params?: z.input<Params>, search?: z.input<Search>, targetHTML?: string) => {
    ...
    return [baseUrl, targetHTML, searchString ? `?${searchString}` : ''].join('')
  }
}

const emptySchema = z.object({})

export function makePostRoute<Params extends z.ZodSchema, Search extends z.ZodSchema, Body extends z.ZodSchema, Result extends z.ZodSchema>(
  route: string,
...
export function makePutRoute<Params extends z.ZodSchema, Search extends z.ZodSchema, Body extends z.ZodSchema, Result extends z.ZodSchema>(
  route: string,
  info: RouteInfo<Params, Search>,
...
export function makeGetRoute<Params extends z.ZodSchema, Search extends z.ZodSchema, Result extends z.ZodSchema>(
  route: string,
  info: RouteInfo<Params, Search>,
...
export function makeDeleteRoute<Params extends z.ZodSchema, Search extends z.ZodSchema>(
  ...
  const routeBuilder: DeleteRouteBuilder<Params> = (p?: z.input<Params>, search?: z.input<Search>, options?: FetchOptions): Promise<void> => {
...
export function makeRoute<Params extends z.ZodSchema, Search extends z.ZodSchema = typeof emptySchema>(
  route: string,
  info: RouteInfo<Params, Search>
): RouteBuilder<Params, Search> {
  const urlBuilder: RouteBuilder<Params, Search> = createRouteBuilder(route, info) as RouteBuilder<Params, Search>
  ...
  urlBuilder.ParamsLink = function RouteLink({
    ...
    return (
      <Link {...props} href={urlBuilder(linkParams, linkSearch, targetHTML)}>
        {children}
      </Link>
    )
  }
  ...
  urlBuilder.Link = function RouteLink({
    ...
    return (
      <Link {...extraProps} href={urlBuilder(info.params.parse(props), linkSearch, targetHTML)}>
        {children}
      </Link>
    )
  }
