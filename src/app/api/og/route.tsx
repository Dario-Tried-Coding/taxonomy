...
import { ogImageSchema } from '@/lib/validators/og'
import { siteConfig } from '@/config/site.config'

export const runtime = 'edge'

const interRegular = fetch(new URL('../../../assets/fonts/Inter-Regular.ttf', import.meta.url)).then((res) => res.arrayBuffer())
const interBold = fetch(new URL('../../../assets/fonts/CalSans-SemiBold.ttf', import.meta.url)).then((res) => res.arrayBuffer())
        ...
        >
          <svg width='212' height='50' viewBox='0 0 212 50' fill='none'>
            <g clip-path='url(#a)' fill={paint}>
              ...
              <path fill-rule='evenodd' clip-rule='evenodd' d='M30.802 39.977 6.478 9.77H0v30.193h5.182V16.225l19.11 23.752h6.51Z' />
          ...
          <div tw='flex flex-col flex-1 py-10'>
            <div tw='flex text-xl uppercase font-bold tracking-tight' style={{ fontFamily: 'Inter', fontWeight: 'normal' }}>
              {values.type}
            </div>
            <div
          ...
          <div tw='flex items-center w-full justify-between'>
            ...
            <div tw='flex items-center text-xl' style={{ fontFamily: 'Inter', fontWeight: 'normal' }}>
              <svg width='32' height='32' viewBox='0 0 48 48' fill='none'>
                ...
                />
                <path d='M18 36c-9.02 4-10-4-14-4' stroke={paint} stroke-width='2' stroke-linecap='round' stroke-linejoin='round' />
              </svg>
              <div tw='flex ml-2'>{siteConfig.github.urlShort}</div>
            </div>
          </div>
        </div>
      ),
